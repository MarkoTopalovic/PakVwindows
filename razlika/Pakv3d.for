...
C
      ...
      DIMENSION TT21(44),TT210(44),QUK(20),QUM(20)
...
C=======================================================================
     ...
     1                  KOTES,IDJSTAMP1,NP3D1)
      ...
      DIMENSION VG(3,NET,*),GG(3,NET,*),QUK(20),QUM(20),NREDT(4)
...
C
	IF (NKONT.GT.0) THEN
      ...
      ENDDO
       IF (INDSC.EQ.0) THEN
	  WRITE(IIZLAZ,7023) 
	  WRITE(IIZLAZ,5005) VVREME,QK
	  WRITE(IIZLAZ,5005) VVREME,(QUK(L),L=1,NKONT)
        WRITE(IIZLAZ,5005) VVREME,QM
	  WRITE(IIZLAZ,5005) VVREME,(QUM(L),L=1,NKONT)
        WRITE(IIZLAZ,5005) VVREME,QK+QM
	  WRITE(IIZLAZ,5005) VVREME,((QUK(L)+QUM(L)),L=1,NKONT)
 	  WRITE(21,5005) VVREME,(QUK(L),L=1,NKONT)
	  WRITE(21,5005) VVREME,(QUM(L),L=1,NKONT)
	  WRITE(21,5005) VVREME,((QUK(L)+QUM(L)),L=1,NKONT)
	 ENDIF
	ENDIF
C
      RETURN
...
C
      ...
      DIMENSION AKONST(3,5,*),QPR(21),QUK(20),QUM(20)
...
C
      ...
      DIMENSION QUK(20),QUM(20),NRED(10),NRED26(6),NRED28(8)
  ...
  723 CONTINUE
      ...
      ENDDO
       ...
       WRITE(IIZLAZ,5056) QK,QM,QK+QM
        WRITE(21,5005) (QUK(L),L=1,NKONT)
        WRITE(21,5005) (QUM(L),L=1,NKONT)
        WRITE(21,5005) ((QUK(L)+QUM(L)),L=1,NKONT)
!        WRITE(IIZLAZ,5005) QK
!        WRITE(IIZLAZ,5005) (QUK(L),L=1,NKONT)
!        WRITE(IIZLAZ,5005) QM
!        WRITE(IIZLAZ,5005) (QUM(L),L=1,NKONT)
!        WRITE(IIZLAZ,5005) QK+QM
!        WRITE(IIZLAZ,5005) ((QUK(L)+QUM(L)),L=1,NKONT)
C stampanje protoka po 1 konturi u POT.TXT
 ...
 5055 FORMAT(2X,I5,10(1PE13.5))  	
 5056 FORMAT(7X,10(1PE13.5))  	
C
      RETURN
      END
C=======================================================================
...
C      DIMENSION KONT(9,MAXLIN,*),NEL(NDIMM,*)
      ...
      DIMENSION QUK(20),QUM(20),NRED(8)
      DATA NRED/8,4,2,6,7,3,1,5/  
C
C*    BLOK ZA STAMPANJE PROTOKA PO ELEMENTIMA ZA GRAFIKU - PRIVREMENO
      JEDAN=1
